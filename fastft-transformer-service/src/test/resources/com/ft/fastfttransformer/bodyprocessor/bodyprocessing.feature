...
#  Scenario Outline:
#    Given Tag name is <tagname> is assigned to rule RetainWithoutAttributesXMLEventHandler
#    // given the body processor encounter tagname
#    // then it invokes the rule
#
