 ...
 */
public class ImageModelUuidGenerator {
  private static final byte[] NS_URL = "6ba7b811-9dad-11d1-80b4-00c04fd430c8".getBytes(UTF_8);
  ...
  private ImageModelUuidGenerator() {/* not instantiable */}
}
