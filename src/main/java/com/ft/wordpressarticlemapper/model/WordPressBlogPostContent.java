...
public class WordPressBlogPostContent extends WordPressContent {

  private final String body;
  private final String opening;

  private WordPressBlogPostContent(
      UUID uuid,
      String title,
      List<String> titles,
      String byline,
  ...
  public static class Builder extends WordPressContent.Builder<WordPressBlogPostContent> {
    ...
    public Builder withValuesFrom(WordPressBlogPostContent content) {
      return ((Builder) super.withValuesFrom(content)).withBody(content.getBody());
    }

    public WordPressBlogPostContent build() {
      return new WordPressBlogPostContent(
          getUuid(),
          getTitle(),
          getTitles(),
          getByline(),
