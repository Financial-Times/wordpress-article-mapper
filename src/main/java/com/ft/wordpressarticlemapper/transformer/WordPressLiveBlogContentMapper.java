...
public class WordPressLiveBlogContentMapper
  ...
  public WordPressLiveBlogContentMapper(
  ...
  @Override
  protected WordPressLiveBlogContent doMapping(
    ...
    WordPressLiveBlogContent.Builder builder =
        (WordPressLiveBlogContent.Builder)
            WordPressLiveBlogContent.builder()
                .withUuid(uuid)
