...
public class NativeWordPressContentValidator {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(NativeWordPressContentValidator.class);
        ...
        if (!isSupportedPostType(nativeWordPressContent)) {
          throw new UnpublishablePostException(
              ...
              String.format(
                  ...
                  findTheType(nativeWordPressContent),
  ...
  private WordPressContentException processWordPressErrorResponse(
      String uuid, NativeWordPressContent nativeWordPressContent) {
    ...
    if ((post != null) && !isSupportedPostType(nativeWordPressContent)) {
      return new UnpublishablePostException(
          uuid, String.format(UNSUPPORTED_POST_TYPE, post.getType(), SUPPORTED_POST_TYPES, uuid));
    }
