...
public class CustomFields {
    ...
    /**
     * 
     * @param assankaMockingbird
     *     The assanka_mockingbird
     */
    @JsonProperty("assanka_mockingbird")
    ...
    /**
     * 
     * @param assankaAtompush
     *     The assanka_atompush
     */
    @JsonProperty("assanka_atompush")
    ...
    /**
     * 
     * @param emailscrapeInclude
     *     The emailscrape_include
     */
    @JsonProperty("emailscrape_include")
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(assankaMockingbird).append(ftblogsAccess).append(assankaAtompush).append(emailscrapeInclude).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(assankaMockingbird, rhs.assankaMockingbird).append(ftblogsAccess, rhs.ftblogsAccess).append(assankaAtompush, rhs.assankaAtompush).append(emailscrapeInclude, rhs.emailscrapeInclude).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
