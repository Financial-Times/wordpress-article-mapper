...
public class CanConnectToMessageQueueProducerProxyHealthcheckTest {
  ...
  @Mock private QueueProxyHealthcheck queueProxyHealthcheck;

  @Before
  public void setUp() {
    HealthcheckConfiguration healthcheckConfiguration =
        new HealthcheckConfiguration(
            "kafka-proxy", 2, "business impact text", "tech summary", "panic guide url");
    healthcheck =
        new CanConnectToMessageQueueProducerProxyHealthcheck(
            queueProxyHealthcheck, healthcheckConfiguration, null);
  }
  ...
  public void shouldReturnHealthyWhenProxyHealthcheckIsHealthy() throws Exception {
    ...
    assertThat(
        actualHealthCheckResult.checkOutput(),
        containsString(expectedHealthCheckResult.checkOutput()));
  }
