...
public class RemoteServiceDependencyHealthCheckTest {
  ...
  @Mock private EndpointConfiguration mockEndpointConfiguration;
  @Mock private Client mockClient;
  @Mock private WebResource mockResource;
  @Mock private WebResource.Builder mockBuilder;
  @Mock private ClientResponse mockClientResponse;
  ...
  public void setUp() throws Exception {
    ...
    when(mockEndpointConfiguration.getJerseyClientConfiguration())
        .thenReturn(new JerseyClientConfiguration());
  ...
  @Test
  public void testWhenNativeReaderPingReturnsUnexpectedStatusHealthCheckShouldFail()
      throws Exception {
    when(mockClientResponse.getStatus()).thenReturn(503);

    AdvancedResult expectedHealthCheckResult =
        AdvancedResult.error(healthCheck, "Unexpected status : 503");
    AdvancedResult actualHealthCheckResult = healthCheck.checkAdvanced();
  ...
  public void testWhenNativeReaderPingIsDownHealthCheckShouldFail() throws Exception {
    ...
    AdvancedResult expectedHealthCheckResult =
        AdvancedResult.error(healthCheck, "NativeRW ping: Exception during ping, timeout");
    AdvancedResult actualHealthCheckResult = healthCheck.checkAdvanced();
