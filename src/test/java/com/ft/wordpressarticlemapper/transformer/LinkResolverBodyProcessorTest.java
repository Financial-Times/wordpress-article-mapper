...
public class LinkResolverBodyProcessorTest {
  ...
  private static final Pattern SHORT_URL_PATTERN =
      Pattern.compile("http:\\/\\/short\\.example\\.com\\/.*");
  private static final String FULL_WORDPRESS_URL =
      "http://something.somethingelse.ft.com/ablog/2016/04/29/the-title-of-the-post/";
  ...
  public void thatUuidLinksAreResolvedToContent() {
    ...
    String bodyWithUuidLink =
        "<body><p>Blah blah blah <a href=\"" + uuidUrl + "\">usw</a> ...</p></body>";
    ...
    CLIENT_MOCK_BUILDER.mockContentRead(
        contentReadClient,
        CONTENT_READ_URI,
  ...
  public void thatShortenedLinksAreResolvedToContent() {
    ...
    CLIENT_MOCK_BUILDER.mockResolverRedirect(
        resolverClient, shortUrl, URI.create(resolvedIdentifier));
    URI queryURI =
        CLIENT_MOCK_BUILDER.buildDocumentStoreQueryUri(
            DOC_STORE_QUERY, URI.create(BLOG_AUTHORITY), URI.create(resolvedIdentifier));
  ...
  public void thatMaximumNumberOfLinksAreResolvedToContent() {
    ...
    CLIENT_MOCK_BUILDER.mockResolverRedirect(
        resolverClient, shortUrl[0], URI.create(resolvedIdentifier));
    CLIENT_MOCK_BUILDER.mockResolverRedirect(
        resolverClient, shortUrl[1], URI.create(resolvedIdentifier2));
    CLIENT_MOCK_BUILDER.mockResolverRedirect(
        resolverClient, shortUrl[2], URI.create(resolvedIdentifier2));
    CLIENT_MOCK_BUILDER.mockDocumentStoreQuery(
        documentStoreQueryClient,
        DOC_STORE_QUERY,
    ...
    try {
      ...
      assertLogEvent(
          logger, "Article contains too many links to resolve\\. Omitting.*" + shortUrl[2] + ".*");
    } finally {
  ...
  public void thatShortenedLinksForNonFTContentAreNotTransformed() {
    ...
    String body = "<body><p>Blah blah blah <a href=\"" + shortUrl + "\">usw</a> ...</p></body>";
  ...
  public void thatOtherLinksAreNotTransformed() {
    String body =
        "<body><p>Blah blah blah <a href=\"http://www.example.com/foobar\">usw</a> ...</p></body>";
  ...
  public void thatCircularShortenedLinksAreNotTransformed() {
    URI shortUrl = URI.create("http://short.example.com/foobar");
    String body =
        "<body><p>Blah blah blah <a href=\""
            + shortUrl.toASCIIString()
            + "\">usw</a> ...</p></body>";
  ...
  public void thatShortenedLinksResolvedButNotFoundAreNotTransformed() {
    ...
    URI queryURI =
        CLIENT_MOCK_BUILDER.buildDocumentStoreQueryUri(
            DOC_STORE_QUERY, URI.create(BLOG_AUTHORITY), resolvedIdentifier);
    CLIENT_MOCK_BUILDER.mockDocumentStoreQuery(
        documentStoreQueryClient, queryURI, resolvedIdentifier, SC_NOT_FOUND);
  ...
  public void thatFullWordpressLinksAreResolvedToContent() {
    ...
    UUID ftContentUUID = UUID.randomUUID();
    String bodyWithShortLink =
        "<body><p>Blah blah blah <a href=\"" + fullUrl + "\">usw</a> ...</p></body>";
    ...
    URI queryURI =
        CLIENT_MOCK_BUILDER.buildDocumentStoreQueryUri(
            DOC_STORE_QUERY, URI.create(BLOG_AUTHORITY), fullUrl);
    CLIENT_MOCK_BUILDER.mockDocumentStoreQuery(
        documentStoreQueryClient,
        queryURI,
        URI.create("http://www.ft.com/content/" + ftContentUUID),
  ...
  public void thatFullWordpressLinksResolvedButNotFoundAreNotTransformed() {
    URI resolvedIdentifier = URI.create("http:/www.ft.com/resolved/foo/bar");
    String body =
        "<body><p>Blah blah blah <a href=\"" + FULL_WORDPRESS_URL + "\">usw</a> ...</p></body>";

    CLIENT_MOCK_BUILDER.mockResolverRedirect(
        resolverClient, URI.create(FULL_WORDPRESS_URL), resolvedIdentifier);
    CLIENT_MOCK_BUILDER.mockDocumentStoreQuery(
        documentStoreQueryClient,
        DOC_STORE_QUERY,
        URI.create(BLOG_AUTHORITY),
