...
public class WordPressLiveBlogContentTransformerTest {
  ...
  public void setUp() {
    transformer =
        new WordPressLiveBlogContentMapper(
            brandResolver, identifierBuilder, syndicationManager, CANONICAL_WEB_URL_TEMPLATE);
  ...
  @Test
  public void thatLiveBlogPostWithFeaturedImageIsTransformed() throws Exception {
