...
public class StAXTransformingBodyProcessorTest {
    ...
    public void shouldProcessVideoTagCorrectly() {
        ...
        assertThat("processedBody", processedBody, is(equalTo("<a data-asset-type=\"video\" href=\"https://www.ft.com/video/7c95e1db-b56f-3e1a-a6d4-606cd24f68b6\" data-embedded=\"true\"></a>")));
    }
    ...
    public void shouldProcessVideoTagCorrectlyYouTube() {
        ...
        String processedBody = bodyProcessor.process(videoText, new BodyProcessingContext(){});
        assertThat("processedBody", processedBody, is(equalTo("<a data-asset-type=\"video\" href=\"https://www.youtube.com/watch?v=fRqCVcSWbDc\" data-embedded=\"true\"></a>")));
    }
    ...
    public void shouldProcessVideoTagCorrectlyYouTube3() {
        ...
        String processedBody = bodyProcessor.process(videoText, new BodyProcessingContext(){});
        assertThat("processedBody", processedBody, is(equalTo("<a data-asset-type=\"video\" href=\"https://www.ft.com/video/7c95e1db-b56f-3e1a-a6d4-606cd24f68b6\" data-embedded=\"true\"></a><a data-asset-type=\"video\" href=\"https://www.youtube.com/watch?v=fRqCVcSWbDc\" data-embedded=\"true\"></a>")));
