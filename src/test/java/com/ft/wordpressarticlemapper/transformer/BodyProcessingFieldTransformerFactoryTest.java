...
public class BodyProcessingFieldTransformerFactoryTest {
  ...
  @Mock private Client contentReadClient;
  ...
  public void setup() {
    ...
    List<BlogApiEndpointMetadata> metadataList =
        ImmutableList.of(
            new BlogApiEndpointMetadata("www.ft.com/resolved", brands, BLOG_CODE, null));
    BlogApiEndpointMetadataManager blogApiEndpointMetadataManager =
        new BlogApiEndpointMetadataManager(metadataList);
  ...
  public void tagsShouldBeTransformed() {
    final String originalBody =
        "<body><p><web-inline-picture fileref=\"/FT/Graphics/Online/Z_"
    ...
    final String expectedTransformedBody =
  ...
  public void nameSpacesShouldBeIgnored() {
    checkTransformation(
        wrapped("<p v:vs=\"|1|\" v:n=\"15\" v:idx=\"11\">Text</p>"), wrapped("<p>Text</p>"));
  }
  ...
  public void shouldRetainBlockQuotes() {
    String expectedSentence =
        "<body><p>Pork porchetta landjaeger hamburger sausage turducken leberkas tongue"
  ...
  public void shouldTransformTweet() {
    String tweetFromWordPress =
        "<body><div data-asset-type=\"embed\"><blockquote class=\"twitter-tweet\" lang=\"en\">"
    ...
    String expectedSentence =
        "<body><blockquote class=\"twitter-tweet\" lang=\"en\">"
            + "<p>Learning from Comcast/TWC? AT&amp;T b DirecTV deal includes collar protecting "
            + "<a href=\"https://twitter.com/search?q=%24DTV&amp;src=ctag\">$DTV</a> shareholders from decline in "
  ...
  public void shouldProcessVideoTagCorrectly() {
    ...
    String wordpressVideoText =
        "<body><div class=\"video-container video-container-ftvideo\" data-aspect-ratio=\"16:9\">\n"
    ...
    String expectedVideo =
        "<body><a data-asset-type=\"video\" data-embedded=\"true\" href=\"https://www.ft.com/video/7c95e1db-b56f-3e1a-a6d4-606cd24f68b6\"></a></body>";
    checkTransformation(wordpressVideoText, expectedVideo);
  }

  @Test
  public void shouldProcessVideoTagCorrectlyYouTube() {
    String wordpressYouTube =
    ...
    String expectedYouTube =
        "<body><a data-asset-type=\"video\" data-embedded=\"true\" href=\"https://www.youtube.com/watch?v=fRqCVcSWbDc\"></a></body>";
  ...
  public void shouldProcessVideoTagCorrectlyYouTube2() {
    String videoText =
        "<body><div class=\"video-container video-container-youtube\" data-aspect-ratio=\"16:9\"><div data-asset-type=\"video\" data-asset-source=\"YouTube\" data-asset-ref=\"fRqCVcSWbDc\">"
            + "<iframe width=\"590\" height=\"331\" src=\"http://www.youtube.com/embed/fRqCVcSWbDc?wmode=transparent\" frameborder=\"0\" >"
            + "</iframe>"
            + "</div></div></body>";
    String expectedYouTube =
  ...
  public void shouldProcessVideoTagCorrectlyVimeo() {
    String videoText =
        "<body><div data-asset-type=\"embed\"><iframe src=\"//player.vimeo.com/video/77761436\" width=\"500\" height=\"208\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><p><a href=\"http://vimeo.com/77761436\">ATROPA -- Sci-fi Short</a> from <a href=\"http://vimeo.com/sasich\">Eli Sasich</a> on <a href=\"https://vimeo.com\">Vimeo</a>.</p></div></body>";
    String expectedVimeo =
        "<body><a data-asset-type=\"video\" data-embedded=\"true\" href=\"https://www.vimeo.com/77761436\"></a><p><a href=\"http://vimeo.com/77761436\">ATROPA -- Sci-fi Short</a> from <a href=\"http://vimeo.com/sasich\">Eli Sasich</a> on <a href=\"https://vimeo.com\">Vimeo</a>.</p></body>";
  ...
  public void shouldProcessBrightcoveVideoCombinedVideoTagsCorrectly() {
    String videoText =
        "<body><p>Some video (brightcove):</p>"
    ...
    String expectedYouTube =
        "<body><p>Some video (brightcove):</p><a data-asset-type=\"video\" data-embedded=\"true\" href=\"https://www.ft.com/video/7c95e1db-b56f-3e1a-a6d4-606cd24f68b6\"></a> <p>Some YouTube video:</p><a data-asset-type=\"video\" data-embedded=\"true\" href=\"https://www.youtube.com/watch?v=fRqCVcSWbDc\"></a></body>";
    when(videoMatcher.filterVideo(any(RichContentItem.class))).thenReturn(exampleYouTubeVideo);
    checkTransformation(videoText, expectedYouTube);
  }
  ...
  public void testShouldRetainImgTagWithValidAttributes() {
    String imageText =
        "<body><img class=\"size-medium wp-image-2015044\" src=\"http://uat.ftalphaville.ft.com/files/2014/11/holy_grail_arthur_sees1-272x149.jpg\" alt=\"I am Arther, King of the Britons Alt Text\" width=\"272\" height=\"149\" /></body>";
    checkTransformation(
        imageText,
        "<body><img alt=\"I am Arther, King of the Britons Alt Text\" height=\"149\" src=\"http://uat.ftalphaville.ft.com/files/2014/11/holy_grail_arthur_sees1-272x149.jpg\" width=\"272\"/></body>");
  }

  @Test
  public void testShouldRemoveImageCaption() {
    String imageWithCaptionText =
        "<body><img class=\"size-medium wp-image-2048592\" title=\"PubQuizGoldman\" src=\"http://int.ftalphaville.ft.com/files/2014/11/PubQuizGoldman-272x188.jpg\" alt=\"Alternate Text\" width=\"272\" height=\"188\" data-img-id=\"2048592\" />"
            + "<p class=\"wp-caption-text\" data-img-id=\"2048592\">Caption for this image</p></div></body>";
    checkTransformation(
        imageWithCaptionText,
        "<body><img alt=\"Alternate Text\" height=\"188\" src=\"http://int.ftalphaville.ft.com/files/2014/11/PubQuizGoldman-272x188.jpg\" width=\"272\"/></body>");
  }

  @Test
  public void thatReadMoreLinkIsRemoved() {
    String bodyWithMoreLink =
        "<body>"
            + "<p>Blah blah blah</p>"
            + "<p><a href=\"http://foo.example.com/\" class=\"more-link\" >Read more</a></p>"
            + "</body>";

    String expectedTransformed = "<body>" + "<p>Blah blah blah</p>" + "</body>";
  ...
  public void thatShortenedLinksAreResolvedToContent() {
    ...
    String bodyWithShortLink =
        "<body><p>Blah blah blah <a href=\"" + shortUrl + "\">usw</a> ...</p></body>";

    String expectedTransformed =
        "<body><p>Blah blah blah <content id=\""
            + ftContentUUID
            + "\" type=\""
            + ARTICLE_TYPE
            + "\">usw</content> ...</p></body>";
    ...
    clientMockBuilder.mockResolverRedirect(
        resolverClient, URI.create(shortUrl), URI.create(resolvedIdentifier));
    ...
    clientMockBuilder.mockContentRead(
        contentReadClient,
        CONTENT_READ_URI,
        ftContentUUID.toString(),
        CONTENT_READ_HOST_HEADER,
        SC_OK);
  ...
  private void checkTransformation(String originalBody, String expectedTransformedBody) {
    ...
    assertThat(
        ...
        IsEqualIgnoringWhiteSpace.equalToIgnoringWhiteSpace(expectedTransformedBody));
  }
