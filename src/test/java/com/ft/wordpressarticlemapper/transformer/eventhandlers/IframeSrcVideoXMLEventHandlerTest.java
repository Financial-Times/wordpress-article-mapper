...
public class IframeSrcVideoXMLEventHandlerTest extends BaseXMLEventHandlerTest {
  ...
  public void shouldUseFallbackHandlerIfSrcIsNotVimeoOrBrightcove() throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<iframe src=\"http://www.dailymotion.com/video/x2gsis0_the-best-of-the-2015-grammys_lifestyle\" width=\"500\" height=\"208\" frameborder=\"0\"></iframe>",
            "iframe");
    eventHandler.handleStartElementEvent(
        startElement, mockXMLEventReader, mockBodyWriter, mockBodyProcessingContext);
    verify(fallbackHandler)
  ...
  public void shouldTransformAndWriteVimeoContentIfAllConditionsAreMet() throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<iframe src=\"//player.vimeo.com/video/77761436\" width=\"500\" height=\"208\" frameborder=\"0\"></iframe>",
            "iframe");
  ...
  public void shouldTransformAndWriteYoutubeContentIfAllConditionsAreMet() throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<iframe src=\"http://www.youtube.com/embed/OQzJR3BqS7o\" width=\"500\" height=\"208\" frameborder=\"0\"></iframe>",
            "iframe");
