...
public class WordPressArticleMapperApplicationComponentTest {
  ...
  private static final String IDENTIFIER_VALUE =
      "http%3A%2F%2Fuat.ftalphaville.ft.com%2F2014%2F10%2F20%2F2013232%2"
  ...
  public void testMessageIsSentWhenContentFoundInWordPress() throws Exception {
    ...
    wordPressArticleMapperAppRule.mockContentReadResponse(
        "8adad508-077b-3795-8569-18e532cabf96", SC_OK);

    wordPressArticleMapperAppRule.mockDocumentStoreQueryResponse(
        AUTHORITY,
        IDENTIFIER_VALUE,
  ...
  private void checkWordPressArticleMessageMessage(Message actual, String txId) throws IOException {
    ...
    Map wordPressBlogPostContent =
        objectMapper.reader(Map.class).readValue(actual.getMessageBody());
    ...
    assertThat(
        (String) jsonPayload.get("body"),
        CoreMatchers.containsString("<content id=\"3fcac834-58ce-11e4-a31b-00144feab7de\""));
    assertThat(
        (String) jsonPayload.get("body"),
        CoreMatchers.containsString("<content id=\"8adad508-077b-3795-8569-18e532cabf96\""));
    assertThat(
        (String) jsonPayload.get("opening"),
        CoreMatchers.containsString("<content id=\"3fcac834-58ce-11e4-a31b-00144feab7de\""));
    assertThat(
        (String) jsonPayload.get("opening"),
        CoreMatchers.containsString("<content id=\"8adad508-077b-3795-8569-18e532cabf96\""));
    ...
    assertThat(
        jsonPayload.get("canBeSyndicated"), equalTo(Syndication.VERIFY.getCanBeSyndicated()));
    assertThat(
        jsonPayload.get("canonicalWebUrl"),
        equalTo(String.format(CANONICAL_WEB_URL_TEMPLATE, uuid)));
    assertThat(
        jsonPayload.get("webUrl"),
        equalTo("http://uat.ftalphaville.ft.com/2014/10/21/2014692/the-6am-london-cut-277/"));
  }
  ...
  public void testExceptionIsThrownWhenMessageHasBodyNotFromWordPress() throws Exception {
    Message message = getMessage("wordPress/__files/WILL_RETURN_200-body-not-from-wordpress.json");
  ...
  public void testExceptionIsThrownWhenIncorrectBlogType() throws Exception {
    Message message = getMessage("wordPress/__files/WILL_RETURN_200-incorrect-blog-type.json");
  ...
  public void testExceptionIsThrownWhenIncorrectContentType() throws Exception {
    Message message = getMessage("wordPress/__files/WILL_RETURN_200-incorrect-content-type.json");
  ...
  public void testExceptionIsThrownWhenMessageHasNoApiUrl() throws Exception {
    Message message = getMessage("wordPress/__files/WILL_RETURN_200-no-apiurl-on-response.json");
  ...
  public void testExceptionIsThrownWhenMessageContentIsUnsupported() throws Exception {
    Message message = getMessage("wordPress/__files/WILL_RETURN_200-unsupported-content.json");

    thrown.expect(UntransformablePostException.class);
    thrown.expectMessage(
        "Not a valid WordPress article for publication - body of transformed post is empty");
  ...
  private void testExceptionIsThrownForContentReadStatusCode(int status) throws Exception {
    ...
    Message message = getMessage("wordPress/__files/wordpress-content-read-error.json");
  ...
  public void testWhenDocumentStoreApiReturns404() throws Exception {
    wordPressArticleMapperAppRule.mockDocumentStoreQueryResponse(
        AUTHORITY, IDENTIFIER_VALUE, SC_NOT_FOUND, StringUtils.EMPTY);
    Message message =
        getMessage("wordPress/__files/wordpress-content-document-store-api-error.json");
    ...
    Map wordPressBlogPostContent =
        objectMapper.reader(Map.class).readValue(sentMessage.getMessageBody());
    Map jsonPayload = (Map) wordPressBlogPostContent.get("payload");

    assertThat(
        (String) jsonPayload.get("body"),
        not(CoreMatchers.containsString("<content id=\"8adad508-077b-3795-8569-18e532cabf96\"")));
    assertThat(
        (String) jsonPayload.get("opening"),
        not(CoreMatchers.containsString("<content id=\"8adad508-077b-3795-8569-18e532cabf96\"")));
  }
