  ...
  public void thatExceptionIsThrownWhenStatusIsNull() throws Exception {
    NativeWordPressContent content =
        JACKSON_MAPPER
            .reader(NativeWordPressContent.class)
            .readValue(
                loadFile("wordPress/__files/WILL_RETURN_STATUS_NULL-body-from-wordpress.json"));
  ...
  public void thatExceptionIsThrownWhenStatusIsUnknown() throws Exception {
    NativeWordPressContent content =
        JACKSON_MAPPER
            .reader(NativeWordPressContent.class)
            .readValue(
                loadFile("wordPress/__files/WILL_RETURN_STATUS_UNKNOWN-body-from-wordpress.json"));
