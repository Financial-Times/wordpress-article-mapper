...
public class StAXTransformingBodyProcessorTest {
    ...
    public void shouldProcessVideoTagCorrectly() {
        ...
        assertThat("processedBody", processedBody, is(equalTo("<a data-asset-type=\"video\" href=\"http://video.ft.com/3791005080001\" data-embedded=\"true\"></a>")));
    }
    ...
    public void shouldProcessVideoTagCorrectlyYouTube() {
        ...
        String processedBody = bodyProcessor.process(videoText, new BodyProcessingContext(){});
        assertThat("processedBody", processedBody, is(equalTo("<a data-asset-type=\"video\" href=\"http://www.youtube.com/embed/fRqCVcSWbDc?wmode=transparent\" data-embedded=\"true\"></a>")));
    }
    ...
    public void shouldProcessVideoTagCorrectlyYouTube3() {
        ...
        String processedBody = bodyProcessor.process(videoText, new BodyProcessingContext(){});
        assertThat("processedBody", processedBody, is(equalTo("<a data-asset-type=\"video\" href=\"http://video.ft.com/3791005080001\" data-embedded=\"true\"></a><a data-asset-type=\"video\" href=\"http://www.youtube.com/embed/fRqCVcSWbDc?wmode=transparent\" data-embedded=\"true\"></a>")));
