...
public class StAXTransformingBodyProcessorTest {
    ...
    public void shouldProcessVideoTagCorrectly() {
        ...
        assertThat("processedBody", processedBody, is(equalTo("<a href=\"http://video.ft.com/3791005080001\"></a>")));
    }
    ...
    public void shouldProcessVideoTagCorrectlyYouTube() {
        ...
        String processedBody = bodyProcessor.process(videoText, new BodyProcessingContext(){});
        assertThat("processedBody", processedBody, is(equalTo("<a href=\"http://www.youtube.com/embed/fRqCVcSWbDc?wmode=transparent\"></a>")));
    }
    ...
    public void shouldProcessVideoTagCorrectlyYouTube3() {
        ...
        String processedBody = bodyProcessor.process(videoText, new BodyProcessingContext(){});
        assertThat("processedBody", processedBody, is(equalTo("<a href=\"http://video.ft.com/3791005080001\"></a><a href=\"http://www.youtube.com/embed/fRqCVcSWbDc?wmode=transparent\"></a>")));
