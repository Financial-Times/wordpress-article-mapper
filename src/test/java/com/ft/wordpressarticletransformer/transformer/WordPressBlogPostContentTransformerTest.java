...
public class WordPressBlogPostContentTransformerTest {
    ...
    public void thatBlogPostIsTransformed() {
        ...
        WordPressBlogPostContent actual = transformer.transform(TX_ID, REQUEST_URI, post, POST_UUID, FT_BRAND);
    ...
    public void thatTransformerFailsWhenThereAreNoAuthors() {
        ...
        transformer.transform(TX_ID, REQUEST_URI, post, POST_UUID, FT_BRAND);
    }
