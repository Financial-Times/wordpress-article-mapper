...
For details of which rules apply for particular tags, see bodyprocessing.feature
  ...
  Examples:
    ...
    | STRIP ELEMENT AND CONTENTS            | applet    | <body>pretext <applet id="myApplet">Text</applet>posttext</body>   | pretext posttext  |
    | STRIP ELEMENT AND LEAVE CONTENT       | unknown   | <body><unknown id="myUnknown">Some unknown text</unknown></body>   | Some unknown text |
    | RETAIN ELEMENT AND REMOVE ATTRIBUTES  | h1        | <body><h1 id="attr1" class="attr2">Text</h1></body>                | <h1>Text</h1>     |
