...
For details of which rules apply for particular tags, see bodyprocessing.feature
  ...
  Scenario Outline: Images are retained with valid attributes and captions are removed
    Given I have text in Wordpress XML like <before>
    When I transform it into our Content Store format
    Then the body should be like <after>
  ...
  Examples:
    | before                                                                                                                                                                                   | after                  |
    | <body><p>Image:</p><div id="attachment_2015044" class="wp-caption alignnone" style="width: 282px"><a href="http://uat.ftalphaville.ft.com/files/2014/11/holy_grail_arthur_sees1.jpg" target="_blank"><img height="149" width="272" src="http://uat.ftalphaville.ft.com/files/2014/11/holy_grail_arthur_sees1-272x149.jpg" alt="I am Arther, King of the Britons Alt Text"/></a><p class="wp-caption-text" data-img-id="2048592">I am Arther, King of the Britons Caption</p></div></body>                | <body><p>Image:</p><a href="http://uat.ftalphaville.ft.com/files/2014/11/holy_grail_arthur_sees1.jpg"><img alt="I am Arther, King of the Britons Alt Text" height="149" src="http://uat.ftalphaville.ft.com/files/2014/11/holy_grail_arthur_sees1-272x149.jpg" width="272"/></a></body>                               |
    | <body><p>Check this chart out!</p><p><a href="http://uat.ftalphaville.ft.com/files/2014/10/Chart5.png" target="_blank"><img class="aligncenter size-full wp-image-2012992" src="http://uat.ftalphaville.ft.com/files/2014/10/Chart5-e1413767777269.png" alt="" width="300" height="660"/></a></p><p>Profit!</p></body>                                                                                                                                                                                   | <body><p>Check this chart out!</p><p><a href="http://uat.ftalphaville.ft.com/files/2014/10/Chart5.png"><img alt="" height="660" src="http://uat.ftalphaville.ft.com/files/2014/10/Chart5-e1413767777269.png" width="300"/></a></p><p>Profit!</p></body>                                           |